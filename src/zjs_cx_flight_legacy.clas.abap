CLASS zjs_cx_flight_legacy DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS:
      gc_msgid TYPE symsgid VALUE 'ZJS_CM_FLIGHT_LEGAC',

      BEGIN OF agency_unkown,
        msgid TYPE symsgid VALUE 'ZJS_CM_FLIGHT_LEGAC',
    ...
    METHODS constructor
      IMPORTING
        ...
        travel_id             TYPE zjs_de_travel_id OPTIONAL
        booking_id            TYPE zjs_de_booking_id OPTIONAL
        booking_supplement_id TYPE zjs_de_booking_supplement_id OPTIONAL
        agency_id             TYPE zjs_de_agency_id OPTIONAL
        customer_id           TYPE zjs_de_customer_id OPTIONAL
        ...
        begin_date            TYPE zjs_de_begin_date OPTIONAL
        end_date              TYPE zjs_de_end_date OPTIONAL
        booking_date          TYPE zjs_de_booking_date OPTIONAL
        flight_date           TYPE zjs_de_flight_date OPTIONAL
        status                TYPE zjs_de_travel_status OPTIONAL
        currency_code         TYPE zjs_de_currency_code OPTIONAL
        reamaining_travel     TYPE i OPTIONAL
        uname                 TYPE syuname OPTIONAL.


    DATA: mv_travel_id             TYPE zjs_de_travel_id,
          mv_booking_id            TYPE zjs_de_booking_id,
          mv_booking_supplement_id TYPE zjs_de_booking_supplement_id,
          mv_agency_id             TYPE zjs_de_agency_id,
          mv_customer_id           TYPE zjs_de_customer_id,
          ...
          mv_begin_date            TYPE zjs_de_begin_date,
          mv_end_date              TYPE zjs_de_end_date,
          mv_booking_date          TYPE zjs_de_booking_date,
          mv_flight_date           TYPE zjs_de_flight_date,
          mv_status                TYPE zjs_de_travel_status,
          mv_currency_code         TYPE zjs_de_currency_code,
...
CLASS ZJS_CX_FLIGHT_LEGACY IMPLEMENTATION.
