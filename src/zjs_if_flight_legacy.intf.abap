...
INTERFACE zjs_if_flight_legacy
  PUBLIC.
...
******************************
  ...
  "! Table type of the table zjs_TRAVEL
  TYPES tt_travel             TYPE zjs_tt_travel.
  "! Table type of the table zjs_BOOKING
  TYPES tt_booking            TYPE zjs_tt_booking.
  "! Table type of the table zjs_BOOK_SUPPL
  TYPES tt_booking_supplement TYPE zjs_tt_booking_supplement.
  "! Table type of the table zjs_FLIGHT
  TYPES tt_flight             TYPE zjs_tt_flight.
...
******************
  ...
  TYPES ts_travel_key TYPE zjs_st_travel_key.
  "! Table type that contains only the keys of Travel
  TYPES tt_travel_key TYPE zjs_tt_travel_key.

  "! Key structure of Booking
  TYPES ts_booking_key TYPE zjs_st_booking_key.
  "! Table type that contains only the keys of Booking
  TYPES tt_booking_key TYPE zjs_tt_booking_key.

  "! Key structure of Booking Supplements
  TYPES ts_booking_supplement_key TYPE zjs_st_booking_supplement_key.
  "! Table type that contains only the keys of Booking Supplements
  TYPES tt_booking_supplement_key TYPE zjs_tt_booking_supplement_key.



***********************************************************************************************************************************
* Flag structures for data components                                                                                             *
* IMPORTANT: When you add or remove fields from zjs_TRAVEL, ZJS_BOOKING, ZJS_BOOK_SUPPL you need to change the following types *
***********************************************************************************************************************************
  ...
  TYPES ts_travel_intx TYPE zjs_st_travel_intx.
  "! <strong>Flag structure for Booking data. </strong><br/>
  "! Each component identifies if the corresponding data has been changed.
  "! Where <em>abap_true</em> represents a change.
  TYPES ts_booking_intx TYPE zjs_st_booking_intx.
  "! <strong>Flag structure for Booking Supplement data. </strong><br/>
  "! Each component identifies if the corresponding data has been changed.
  "! Where <em>abap_true</em> represents a change.
  TYPES ts_booking_supplement_intx TYPE zjs_st_booking_supplement_intx.
...
**********************************************************************
  ...
  TYPES ts_travelx TYPE zjs_st_travelx.
  TYPES tt_travelx TYPE zjs_tt_travelx.

  TYPES ts_bookingx TYPE zjs_st_bookingx.
  TYPES tt_bookingx TYPE zjs_tt_bookingx.

  TYPES ts_booking_supplementx TYPE zjs_st_booking_supplementx.
  TYPES tt_booking_supplementx TYPE zjs_tt_booking_supplementx.
...
*********
  ...
  TYPES:
    ...
    "! </ul>
    BEGIN OF ENUM action_code_enum STRUCTURE action_code BASE TYPE zjs_de_action_code,
  ...
  TYPES:
    ...
    "! </ul>
    BEGIN OF ENUM travel_status_enum STRUCTURE travel_status BASE TYPE zjs_de_travel_status,
      initial   VALUE IS INITIAL,
      new       VALUE 'N',
      planned   VALUE 'P',
      booked    VALUE 'B',
...
************************
  ...
  TYPES ts_travel_in TYPE zjs_st_travel_in.
  ...
  TYPES ts_booking_in TYPE zjs_st_booking_in.
  "! INcoming table type of the node Booking.  It contains the booking key and data fields.
  TYPES tt_booking_in TYPE zjs_tt_booking_in.
  ...
  TYPES ts_booking_supplement_in TYPE zjs_st_booking_supplement_in.
  "! INcoming table type of the node Booking Supplement.  It contains the booking key, booking supplement key and data fields.
  TYPES tt_booking_supplement_in TYPE zjs_tt_booking_supplement_in.
...
**********************************************************************
  ...
  CONSTANTS:
    ...
    late_numbering_boundary TYPE zjs_de_travel_id VALUE '90000000',
...
*****************
  ...
  "! Table of messages
  TYPES tt_message TYPE zjs_tt_message.
