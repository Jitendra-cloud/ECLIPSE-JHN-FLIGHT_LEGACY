CLASS zjs_cl_flight_amdp DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC  .
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS convert_currency AMDP OPTIONS CDS SESSION CLIENT DEPENDENT
                                        IMPORTING VALUE(iv_amount)               TYPE ZJS_DE_total_price
                                                  VALUE(iv_currency_code_source) TYPE ZJS_DE_currency_code
                                                  VALUE(iv_currency_code_target) TYPE ZJS_DE_currency_code
                                                  VALUE(iv_exchange_rate_date)   TYPE d
                                        EXPORTING VALUE(ev_amount)               TYPE ZJS_DE_total_price
                                         .
ENDCLASS.



CLASS ZJS_CL_FLIGHT_AMDP IMPLEMENTATION.
